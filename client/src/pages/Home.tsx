    ...
    <div className='w-full h-screen bg-purple-200 overflow-hidden flex flex-col items-center justify-center'>
      ...
      <img src="/right.png" alt="right-bottom" className='h-2/3 absolute bottom-0 right-0' />
			...
			<div className='flex flex-col items-center'>
				...
				<button onClick={() => {navigate(`/shot?url=${url}`)}} className='w-2/3 h-12 px-4 p-3 rounded-full border-2 border-white hover:shadow-lg hover:shadow-black duration-500 text-white text-sm font-medium bg-gradient-to-br from-purple-500 to-rose-500 my-5'>Start Capture</button>
